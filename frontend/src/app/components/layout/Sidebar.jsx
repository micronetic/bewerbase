...
export default function Sidebar({ hideMobile }) {
  ...
  return (
    <aside
      className={`flex-col gap-y-10 py-6 transition-all duration-200 ease-out border-r border-r-light-grey/20 ${collapsed ? "w-[60px] px-2" : "w-[350px] px-6"} ${hideMobile ? "hidden md:flex" : ""}`}
    >
      <div
